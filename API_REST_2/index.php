...
<body>
    ...
    <script>
        ...
        function comprobarElToken() {
            var variableSesion = sessionStorage.getItem(tokenID);
            var sesionParseada = JSON.parse(variableSesion);
            var tokenID = sesionParseada.tokenID;
            var usuarioID = sesionParseada.usuarioID;

            comprobarToken(usuarioID, tokenID);
        }
    </script>
